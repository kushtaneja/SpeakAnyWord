...
public struct SpeechTweak {
    ...
    func twistValue(fromNormalizedValue normalizedValue: CGFloat) -> Float {
        ...
        return SpeechTweak.twist(normalizedValue: normalizedValueInDefinedRange, forType: type)
    }
    
    public static func twist(normalizedValue: CGFloat, forType type: SpeechTweakType) -> Float {
